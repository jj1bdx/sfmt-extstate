...
void function_tests(void) {
    ...
    printf("\n");
    printf("init_gen_rand(1234):");
    init_gen_rand(1234, &testtable[0]);
    for (i = 0; i < N32; i++) {
	if (0 == i % 4) {
	    printf("\n");
	}
    ...
    printf("init_gen_rand(80273972)\n");
    init_gen_rand(80273972, &testtable[0]);
    for (i = 0; i < 8; i++) {
	printf("%u ", testtable32[i]);
    }
    printf("\n");
    ...
    printf("init_gen_rand(3647962945)\n");
    init_gen_rand(3647962945, &testtable[0]);
    for (i = 0; i < 8; i++) {
	printf("%u ", testtable32[i]);
    }
    printf("\n");
    ...
    printf("init_gen_rand(3363231301)\n");
    init_gen_rand(3363231301, &testtable[0]);
    for (i = 0; i < 8; i++) {
	printf("%u ", testtable32[i]);
    }
    printf("\n");
    ...
    printf("init_by_array(ini, 4)\n");
    printf("ini[4] = {0x1234, 0x5678, 0x9abc, 0xdef0};");
    init_by_array(ini, 4, &testtable[0]);
    for (i = 0; i < N32; i++) {
	if (0 == i % 4) {
	    printf("\n");
	}
